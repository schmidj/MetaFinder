...
async def main(
    greet_name: str = "FastMCP 2.0", new_dataset: str = "New Dataset"
):
    result_dict = {}
    ...
    async with client:
        ...
        # Tool 2: run new_dataset_available tool
        result = await client.call_tool("new_dataset_available", {"dataset_name": new_dataset})
        result_dict["new_dataset_available"] = result[0].text
...
if __name__ == "__main__":
    ...
    dataset_name = "Schmid et al. 2025"

    asyncio.run(main(greet_text, dataset_name))